 ...
 * than the other option of float[]
 */
var obj_PredefinedFunctions = {};
(function(){
 ...
 */
var anythingObjectPredefinedFunctions = function(){
    var results = '';

    p("\n-=-=-=-=-=-=-=-=-\nAnything_Class > CompileTime > ObjectUnits > PredefinedFunctions");
    p("-=-=-=-=-\nEx 1 of 2: 5 meters is equal to:");
    var ex1 = obj_PredefinedFunctions.fromMeters(5);    //Sets ex1 to 5 meters
    ...
    var ex2 = obj_PredefinedFunctions.fromFeet(12.5);   //Sets ex2 to 12.5 feet
