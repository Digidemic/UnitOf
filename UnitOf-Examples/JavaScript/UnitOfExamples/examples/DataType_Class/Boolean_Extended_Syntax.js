...
var dataTypeBoolean = function() {
    ...
    function oneLiner_1_Step(){
         ...
         */
        var matchStr_Case_Contains = UnitOf.DataType("UnitOf").toBoolean(["Unit", "unitof", "ThisIsUnitOf"],true, true);//Returns true due to "Unit"
         ...
         * "UnitOf" != "ThisIsUnitOf" | While "UnitOf" with its proper casing exists in "ThisIsUnitOf", contains does not check if the UnitOf.DataType value is contained within the collection, only the vice versa exists.
         */
        var matchStr_NonCase_Contains = UnitOf.DataType("UnitOf").toBoolean(["Unit", "unitof", "ThisIsUnitOf"],false, true);//Returns true: "Unit", "unitof"
         ...
         */
        var matchStr_NonCase_Equals = UnitOf.DataType("UnitOf").toBoolean(["Unit", "unitof", "ThisIsUnitOf"]);//Returns true. only "unitof"
         ...
         * "UnitOf" != "ThisIsUnitOf" | "UnitOf" does not equal "ThisIsUnitOf" due to it starting with "ThisIs"
         */
        var matchStr_Case_Equals = UnitOf.DataType("UnitOf").toBoolean(["Unit", "unitof", "ThisIsUnitOf"],true);//Returns false, no matches
    ...
    function setThenConvert_2_Steps(){
         ...
         */
        var numberMatches = UnitOf.DataType("12.5");//String passed in.

        /*
         Returns true for all
         */
        var t_MatchStr_NonCase_Equals = numberMatches.toBoolean(["1.2","12.5","3"]);    //True, matches "12.5"
        var t_MatchFloat_NonCase_Equals = numberMatches.toBoolean([1.2,12.5,3]);        //True, matches 12.5
        var t_MatchStr_NonCase_Contains = numberMatches.toBoolean([5,12,3],false,true); //True, matches 5 & 12

        /*
         Returns false for all
         */
        var f_MatchStr_NonCase_Equals2 = numberMatches.toBoolean(["1.2","12.55","3"]);      //False, No matches
        var f_MatchFloat_NonCase_Equals2 = numberMatches.toBoolean([1.2,12.55,3]);          //False, No matches
        var f_MatchStr_NonCase_Contains2 = numberMatches.toBoolean([5,12,3],false,false);   //False, No matches
