...
public class Boolean_Extended_Syntax {
    ...
    */
    public static void oneLiner_1_Step(){
         ...
         */
        boolean matchStr_Case_Contains = new UnitOf.DataType("UnitOf").toBoolean(new String[]{"Unit", "unitof", "ThisIsUnitOf"},true, true);//Returns true due to "Unit"
         ...
         * "UnitOf" != "ThisIsUnitOf" | While "UnitOf" with its proper casing exists in "ThisIsUnitOf", contains does not check if the UnitOf.DataType value is contained within the collection, only the vice versa exists.
         */
        boolean matchStr_NonCase_Contains = new UnitOf.DataType("UnitOf").toBoolean(new String[]{"Unit", "unitof", "ThisIsUnitOf"},false, true);//Returns true: "Unit", "unitof"
         ...
         */
        boolean matchStr_NonCase_Equals = new UnitOf.DataType("UnitOf").toBoolean(new String[]{"Unit", "unitof", "ThisIsUnitOf"});//Returns true. only "unitof"
         ...
         * "UnitOf" != "ThisIsUnitOf" | "UnitOf" does not equal "ThisIsUnitOf" due to it starting with "ThisIs"
         */
        boolean matchStr_Case_Equals = new UnitOf.DataType("UnitOf").toBoolean(new String[]{"Unit", "unitof", "ThisIsUnitOf"},true);//Returns false, no matches
    ...
    */
    public static void setThenConvert_2_Steps(){   
        ...
        */
        boolean t_MatchStr_NonCase_Equals = numberMatches.toBoolean(new String[]{"1.2","12.5","3"});     //True, matches "12.5"
        boolean t_MatchFloat_NonCase_Equals = numberMatches.toBoolean(new Float[]{1.2f,12.5f,3f});       //True, matches 12.5
        boolean t_MatchStr_NonCase_Contains = numberMatches.toBoolean(new Integer[]{5,12,3},false,true); //True, matches 5 & 12
        
        /*
        Returns false for all
        */
        boolean f_MatchStr_NonCase_Equals2 = numberMatches.toBoolean(new String[]{"1.2","12.55","3"});    //False, No matches
        boolean f_MatchFloat_NonCase_Equals2 = numberMatches.toBoolean(new Float[]{1.2f,12.55f,3f});      //False, No matches
        boolean f_MatchStr_NonCase_Contains2 = numberMatches.toBoolean(new Integer[]{5,12,3},false,false);//False, No matches
