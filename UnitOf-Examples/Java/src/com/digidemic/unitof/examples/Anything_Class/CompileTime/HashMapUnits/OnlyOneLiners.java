 ...
 * 
 * The units are also passed into UnitOf.Anything as a HashMap<Object,Double>
...
public class OnlyOneLiners {
    ...
    */
    public static double convert(double input, OnlyOneLiners.Units from, OnlyOneLiners.Units to){
        return CUSTOM_LENGTH.convertNow(input, from.name(), to.name());
    }
...
class TestExampleClass_For_OnlyOneLiners{
    public static void run(){
        p("\n-=-=-=-=-=-=-=-=-\nAnything_Class > CompileTime > HashMapUnits > OnlyOneLiners");
