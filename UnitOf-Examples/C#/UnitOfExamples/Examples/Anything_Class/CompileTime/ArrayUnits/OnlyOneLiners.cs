...
using System.Text;
using UnitOf;
using UnitOfExamples.Examples.Anything_Class.CompileTime.ArrayUnits;
...
namespace UnitOfExamples.Examples.Anything_Class.CompileTime.ArrayUnits
{
     ...
     * rather than the other option of Dictionary<Object,Double>. (Examples of Dictionaries in their respected directory)
     */
    public class OnlyOneLiners {
        ...
        */
        public static Unit FEET = new Unit(1);          //Unit "Feet" is the key for all conversions here. All added units are their conversion into 1 foot.
        public static Unit METERS = new Unit(0.3048);   //Unit name/value: 0.3048 Meters in 1 foot.
        public static Unit INCHES = new Unit(12);       //Unit name/value: 12 inches in 1 foot.
        ...
        */
        private static UnitOf.Anything CUSTOM_LENGTH = new UnitOf.Anything(FEET.VAL.ToString(), new double[]{
            FEET.VAL,
            METERS.VAL,
            INCHES.VAL
        });
     ...
     */
    public class TestExampleClass_For_OnlyOneLiners{
