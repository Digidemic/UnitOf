...
namespace UnitOfExamples.Examples.Anything_Class.CompileTime.ArrayUnits
{
    ...
    public class OnlyOneLiners_ShorterCode {
        ...
        */
        public static double FEET = 1;          //Unit "Feet" is the key for all conversions here. All added units are their conversion into 1 foot.
        public static double METERS = 0.3048;   //Unit name/value: 0.3048 Meters in 1 foot. 
        public static double INCHES = 12;       //Unit name/value: 12 inches in 1 foot.
     ...
     */
    public class TestExampleClass_For_OnlyOneLiners_ShorterCode{
