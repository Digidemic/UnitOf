...
namespace UnitOfExamples.Examples.Anything_Class.CompileTime.DictionaryUnits
{
    ...
    public class PredefinedMethods {
        ...
        */
        public void fromFeet(double input){
            CUSTOM_LENGTH.From(Units.FEET.ToString(), input);
        }
        public void fromMeters(double input){
            CUSTOM_LENGTH.From(Units.METERS.ToString(), input);
        }
        public void fromInches(double input){
            CUSTOM_LENGTH.From(Units.INCHES.ToString(), input);
        }
        ...
        */
        public double toFeet(){
            return CUSTOM_LENGTH.To(Units.FEET.ToString());
        }
        public double toMeters(){
            return CUSTOM_LENGTH.To(Units.METERS.ToString());
        }
        public double toInches(){
            return CUSTOM_LENGTH.To(Units.INCHES.ToString());
        }
    ...
    class TestExampleClass_For_PredefinedMethods{
        public static void run(){
            p("\n-=-=-=-=-=-=-=-=-\nAnything_Class > CompileTime > DictionaryUnits > PredefinedMethods");
